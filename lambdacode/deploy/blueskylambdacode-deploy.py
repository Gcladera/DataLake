...
def lambda_handler(event, context):
    try:
        ...
        s3.upload_fileobj(
            Bucket='amzn-s3-tfgdl',
            Key=f'bronze/social_media_relationships/year={year}/month={month}/day={day}/relationships_{timestamp}.parquet',
            Fileobj=buffer_relationships
            )
    
        log_data = {
            "message": "Processant compte de Bluesky",
            "actor": "usuario.bsky.social",
            "status": "success",
            "custom_metric": 42
        }
