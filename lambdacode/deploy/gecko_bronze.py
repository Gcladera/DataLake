...
def lambda_handler(event, context):
    try:
        ...
        s3.upload_fileobj(
            ...
            Key=f'bronze/crypto-bronze/market-ranking-bronze/year={year}/month={month}/day={day}/market-ranking_{timestamp}.parquet',
            Fileobj=top_20_parquet
        )

        s3.upload_fileobj(
            Bucket='amzn-s3-tfgdl',
            Key=f'bronze/crypto-bronze/sentiment-bronze/year={year}/month={month}/day={day}/sentiment_{timestamp}.parquet',
            Fileobj=sentiment_parquet
        )

        s3.upload_fileobj(
                Bucket='amzn-s3-tfgdl',
                Key=f'bronze/crypto-bronze/trending-bronze/year={year}/month={month}/day={day}/trending_{timestamp}.parquet',
